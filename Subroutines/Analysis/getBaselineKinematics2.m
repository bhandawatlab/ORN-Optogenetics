...
% getBaselineKinematics2  calculates the speed, curvature, and duration of
%   each state instance that occur when the fly is experiencing baseline
%   firing rate. This is split between before first entry and after first
%   entry.
%
...
%
%   Output: baseline = structure with fields for before and after first
%               entry. Subfields contain information about speed,
%               curvature, and duration for each instance of states during
